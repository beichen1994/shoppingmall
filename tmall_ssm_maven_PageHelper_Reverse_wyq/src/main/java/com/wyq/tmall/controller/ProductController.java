...
public class ProductController {
    ...
    //在ProductController的delete方法中获取id
    ...
    public String edit(Model model, int id) {
    	//在ProductController的edit方法中，根据id获取product对象
        Product p = productService.get(id);
        //此处画蛇添足
    ...
    //在ProductController的update方法中获取Product对象
    ...
    public String list(int cid, Model model, Page page) {
        ...
        //把分类对象设置到 request的 "c" 产品上。 ( 这个c有什么用呢？ 在 其他-面包屑导航 中会用于显示分类名称)
